...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5l_P2.yaml')
    ...
    parser.add_argument('--multi-scale', action='store_true',default=True, help='vary img-size +/- 25%%')
